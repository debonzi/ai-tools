...
- Treat `GLOSSARY.md` as the canonical source for project terminology. Read it before planning or modifying repository components, and update it when introducing or changing project-specific terms.
